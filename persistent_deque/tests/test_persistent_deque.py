...
from persistent_deque.interface import Kth, NewDeque, PopBack\
  , PopFront, Print, PushBack, PushFront
...
class PersistentDequeTest(unittest.TestCase):
  ...
  def test_2(self):
    ...
    tester.PopFront(9)
    tester.PopFront(10)
    self.assertEqual(tester.Kth(11, 4), 7)
    tester.PopBack(11)
    tester.PopFront(12)
