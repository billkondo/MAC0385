...
from persistent_bst.interface import Delete, Insert, Min, NewBST, Print, Search
...
class PersistentBSTTest(unittest.TestCase):
    ...
    def test_2(self):
        ...
        tester.Insert(7, 6)
        tester.Insert(8, 9)
        self.assertEqual(tester.Print(9), "3 2 1 5 4 8 7 6 9")
        tester.Delete(9, 5)
        self.assertEqual(tester.Print(9), "3 2 1 5 4 8 7 6 9")
        self.assertEqual(tester.Print(10), "3 2 1 6 4 8 7 9")
        tester.Search(10, 5)
        tester.Search(10, 6)
        tester.Search(9, 7)
